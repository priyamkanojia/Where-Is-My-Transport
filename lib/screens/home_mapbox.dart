...
class _Home_mapboxState extends State<Home_mapbox> with SingleTickerProviderStateMixin {
      ...
      bottomNavigationBar: Material(
        ...
        child:TabBar(
          tabs: <Tab>[
            ...
            Tab(icon: Icon(Icons.directions_bus,color: Colors.blue),
            text: 'List',),
            Tab(icon: Icon(Icons.local_taxi,color: Colors.blue),
            text: 'Pool',),
